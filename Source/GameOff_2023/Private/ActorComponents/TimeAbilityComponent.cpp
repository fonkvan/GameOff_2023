...
UTimeAbilityComponent::UTimeAbilityComponent()
	: SlowAmount(0.5f), MaxMeterAmount(100.f), CurrentMeterAmount(100.f), MeterUseRate(0.05f), UseAmount(-1.5f), RefillAmount(0.5f), bAbilityActive(false)
{
...
void UTimeAbilityComponent::UpdateMeter()
{
	...
	OnMeterAmountChanged.ExecuteIfBound(MaxMeterAmount, CurrentMeterAmount);
}